          ...
          <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="space-y-4 mb-6">
              <div>
                ...
                <input
                  type="text"
                  class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary/50"
            ...
            <!-- Pay Button -->
            <button
              class="mt-6 w-full bg-primary text-white py-3 rounded-button font-semibold hover:bg-primary/90 transition">
              Pay Now
            </button>
          </div>
          ...
          <div class="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="space-y-4">
              <div class="flex justify-between">
                <span class="text-gray-700">Assorted Notebooks & Binders</span>
                <span class="font-semibold text-gray-800">$12.50</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-700">Shipping</span>
                <span class="font-semibold text-gray-800">$3.00</span>
              </div>
            ...
            <div class="mt-8 text-sm text-gray-500">
              ...
              <a href="#" class="text-primary underline">Terms</a> and
