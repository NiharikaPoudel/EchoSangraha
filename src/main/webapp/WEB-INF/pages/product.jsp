...
<html lang="en">
  ...
  <body class="bg-[#D9D7B8] min-h-screen">
      ...
      >
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative w-10 h-10 flex items-center justify-center">
            <i
              class="ri-shopping-cart-2-line text-gray-700 hover:text-primary text-xl"
            ></i>
            <span
    ...
    <body class="bg-[#F1EDE4]">
    <!-- Hero Section -->
<section class="bg-[url('/images/hero.jpg')] bg-cover bg-center text-white text-center py-24 px-4">
  <div class="bg-[#A8D8A0]/70 py-12 px-6 rounded-lg backdrop-blur-sm max-w-4xl mx-auto">
    <h1 class="text-4xl md:text-5xl font-bold mb-4">Recycle Smart, Save Resources</h1>
    <p class="text-lg md:text-xl mb-8">Join our mission to reduce waste by sharing and reusing paper supplies across communities</p>
    <button class="bg-green-700 hover:bg-green-800 text-white font-semibold px-6 py-3 rounded-full shadow-lg transition">
      Explore Items
    </button>
  </div>
</section>
    ...
    <!-- Filter Bar -->
    <div class="relative -mt-12 z-10 flex justify-center">
      <div class="bg-white shadow-lg rounded-2xl px-6 py-6 w-full max-w-5xl">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
          <!-- Search Input -->
          <div class="relative w-full md:w-1/2">
            <input
              type="text"
              placeholder="Search event materials..."
              class="w-full py-2 pl-10 pr-4 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary"
            />
            <i class="ri-search-line absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
          </div>
          <!-- Price Range -->
          <div class="flex flex-col md:flex-row items-center gap-2 w-full md:w-1/2">
            <span class="text-sm text-gray-700">NPR 2K</span>
            <input
              type="range"
              min="2000"
              max="10000"
            ...
            />
            <span class="text-sm text-gray-700">NPR 10K+</span>
          </div>
        </div>
      </div>
    </div>
...
<section class="py-12 bg-[#F1EDE4]">
  <div class="container mx-auto px-4">
    <div class="bg-[#F1EDE4] shadow-lg rounded-2xl p-8 text-center">
      <h2 class="text-xl font-bold text-primary mb-1">
        Didn’t find what you're looking for?
      </h2>
      <p class="text-gray-700 mt-2 mb-6 leading-relaxed">
        Connect with our sustainability team to request specific recycled materials or 
        propose a custom recycling initiative for your institution. <br />
        We're here to help you reduce waste and make eco-friendly choices easier.
      </p>
      <a
        href="#"
        class="inline-block bg-primary hover:bg-[#D9D7B8] text-black font-semibold px-6 py-3 rounded-full shadow transition"
      >
        Shop Now ↗
      </a>
    </div>
...
<section class="py-16 bg-[#F1EDE4]">
  <div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-8">
      <h2 class="text-3xl font-bold">Paper & Stationery</h2>
      <a href="#" class="text-primary font-medium flex items-center">
        View All
        <div class="w-5 h-5 ml-1 flex items-center justify-center">
          <i class="ri-arrow-right-line"></i>
    ...
    <div class="relative">
      <div class="flex overflow-x-auto pb-6 space-x-6 no-scrollbar" id="listings-carousel">
        <!-- Item 1 -->
        <div class="listing-card flex-shrink-0 w-64 bg-white rounded-lg shadow-sm overflow-hidden mx-2">
          <div class="h-40 bg-gray-200 relative">
            <img src="images/notebooks-binders.jpg" alt="Notebooks and Binders" class="w-full h-full object-cover object-top" />
            <div class="absolute top-2 right-2 bg-primary text-white text-xs px-2 py-1 rounded">New</div>
          </div>
          <div class="p-4">
            <h3 class="font-semibold text-gray-800 mb-1">Assorted Notebooks & Binders</h3>
            ...
            <div class="flex items-center justify-between text-sm text-gray-600 mt-3">
              ...
              <a href="browserdetail.html" class="bg-primary text-white text-xs px-3 py-1 rounded hover:bg-primary-dark transition">Select</a>
            </div>
          </div>
        </div>

        <!-- Item 2 -->
        <div class="listing-card flex-shrink-0 w-64 bg-white rounded-lg shadow-sm overflow-hidden">
          <div class="h-40 bg-gray-200 relative">
            <img src="images/markers-pens.jpg" alt="Markers and Pens" class="w-full h-full object-cover object-top" />
          </div>
          <div class="p-4">
            <h3 class="font-semibold text-gray-800 mb-1">Premium Markers & Pens Set</h3>
            <div class="flex justify-between items-center mb-2">
        ...
        <div class="listing-card flex-shrink-0 w-64 bg-white rounded-lg shadow-sm overflow-hidden">
          <div class="h-40 bg-gray-200 relative">
            <img src="images/file-organizers.jpg" alt="File Organizers" class="w-full h-full object-cover object-top" />
            <div class="absolute top-2 right-2 bg-orange-500 text-white text-xs px-2 py-1 rounded">Popular</div>
          </div>
          <div class="p-4">
            <h3 class="font-semibold text-gray-800 mb-1">File Organizers Bundle Are Available</h3>
            <div class="flex justify-between items-center mb-2">
        ...
        <div class="listing-card flex-shrink-0 w-64 bg-white rounded-lg shadow-sm overflow-hidden">
          <div class="h-40 bg-gray-200 relative">
            <img src="images/art-supplies.jpg" alt="Art Supplies" class="w-full h-full object-cover object-top" />
          </div>
          <div class="p-4">
            <h3 class="font-semibold text-gray-800 mb-1">Art Supplies Collection Are Available</h3>
            <div class="flex justify-between items-center mb-2">
        ...
        <div class="listing-card flex-shrink-0 w-64 bg-white rounded-lg shadow-sm overflow-hidden">
          <div class="h-40 bg-gray-200 relative">
            <img src="images/textbooks.jpg" alt="Textbooks" class="w-full h-full object-cover object-top" />
            <div class="absolute top-2 right-2 bg-secondary text-white text-xs px-2 py-1 rounded">Best Value</div>
          </div>
          <div class="p-4">
            <h3 class="font-semibold text-gray-800 mb-1">Engineering Textbooks Set Are Available</h3>
            <div class="flex justify-between items-center mb-2">
      ...
      <!-- Carousel Arrows -->
      <button class="absolute left-0 top-1/2 transform -translate-y-1/2 -ml-4 w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center text-gray-600 hover:text-primary z-10" id="prev-btn">
        <i class="ri-arrow-left-s-line text-xl"></i>
      </button>
      <button class="absolute right-0 top-1/2 transform -translate-y-1/2 -mr-4 w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center text-gray-600 hover:text-primary z-10" id="next-btn">
